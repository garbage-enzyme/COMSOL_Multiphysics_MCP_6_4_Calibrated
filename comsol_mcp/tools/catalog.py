...
_TOOLS_BY_REGISTRAR = {
    ...
    "comsol_mcp.tools.geometry_selections.register_geometry_selection_tools": (
    ...
    "comsol_mcp.tools.acoustics_pde.register_acoustics_pde_tools": (
    ...
    "comsol_mcp.tools.surrogate.register_surrogate_tools": (
...
_GROUP_BY_REGISTRAR = {
    ...
    "register_surrogate_tools": "surrogate_evidence",
...
_SIDE_EFFECTS = {
    ...
    "geometry_create_box_selection": "model_mutation",
    "geometry_create_side_selections": "model_mutation",
    ...
    "physics_add_pressure_acoustics": "model_mutation",
    "physics_add_coefficient_form_pde": "model_mutation",
    "physics_add_general_form_pde": "model_mutation",
    "physics_add_weak_form_pde": "model_mutation",
    "physics_configure_acoustic_boundary": "model_mutation",
...
_EXPLICIT_READ_ONLY_TOOLS = frozenset(
    {
        ...
        # The bounded surrogate tools only read and validate artifacts on disk.
        "surrogate_dataset_validate",
        "surrogate_training_preview",
        "surrogate_model_inspect",
        "surrogate_model_verify",
