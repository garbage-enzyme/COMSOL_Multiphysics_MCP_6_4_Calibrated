...
from .robust_condition_controls import normalize_robust_condition_controls
...
def normalize_robust_shape_adapter_configuration(
    ...
    if adapter_id == PERIODIC_MIM_PATCH_ADAPTER_ID:
        ...
        config = _object(
            configuration,
            {"fixture", "tree_readback", "material_tensor_rows", "condition_controls"},
        ...
        condition_controls = normalize_robust_condition_controls(config["condition_controls"])
        normalized_configuration = {
            "fixture": fixture,
