...
ZH_CN = {
    ...
    "SQLite FTS5/BM25 index used by manual_search. Use an ASCII-only full path. The Generate Index action creates or atomically replaces this file.": "manual_search 使用的 SQLite FTS5/BM25 索引。请使用仅含 ASCII 字符的完整路径。“生成索引”会创建或原子替换此文件。",
...
ZH_TW = {
    ...
    "SQLite FTS5/BM25 index used by manual_search. Use an ASCII-only full path. The Generate Index action creates or atomically replaces this file.": "manual_search 使用的 SQLite FTS5/BM25 索引。請使用僅含 ASCII 字元的完整路徑。「產生索引」會建立或原子取代此檔案。",
