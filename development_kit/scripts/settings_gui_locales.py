...
ZH_CN = {
    ...
    "{percent}% — {files}/{total_files} PDFs, {pages}/{total_pages} pages{source}": "{percent}% — {files}/{total_files} 个 PDF，{pages}/{total_pages} 页{source}",
    ...
    "Indexed {pdfs} PDFs and {pages} pages. Corpus fingerprint: {fingerprint}": "已索引 {pdfs} 个 PDF、{pages} 页。语料指纹：{fingerprint}",
...
ZH_TW = {
    ...
    "Cancelling safely...": "正在安全取消……",
    "{percent}% — {files}/{total_files} PDFs, {pages}/{total_pages} pages{source}": "{percent}% — {files}/{total_files} 個 PDF，{pages}/{total_pages} 頁{source}",
    ...
    "Indexed {pdfs} PDFs and {pages} pages. Corpus fingerprint: {fingerprint}": "已索引 {pdfs} 個 PDF、{pages} 頁。語料指紋：{fingerprint}",
